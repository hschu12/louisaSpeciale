...
def main(path,time_limit,constr_heuristic,flip_fct,step_fct):
	...
	for k in range(1,edge_connectivity):
		print('k : ',k)
	...
	return ms,k_list,edge_connectivity,init_max_flows,best_max_flows,first_int_max_flows,best_search_max_flows,step_list,flips_list,non_imp_flips_list,k_tabu_counter_list,G_tabu_counter_list,Max_Flows_list
